  ...
  return (
    <section className="bg-[#FAF7FD] py-24 px-6 font-sans">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="text-gray-500 text-base mb-16 max-w-3xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row items-stretch justify-center gap-8 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-gray-100 flex-1 text-left flex flex-col">
            <div className="flex justify-between items-start mb-6">
              ...
              <span className="bg-purple-100 text-[#6219D1] text-[9px] font-bold px-3 py-1 rounded-full uppercase">
                3-Month Plan
              </span>
            </div>
            
            <div className="text-center mb-8">
              <h3 className="text-lg font-bold text-gray-900 mb-4">Foundation + Internship</h3>
              <div className="flex items-center justify-center mb-1">
                <span className="text-4xl font-black text-gray-900">₦150,000</span>
              </div>
          ...
          <div className="relative flex-1 flex flex-col mt-8 lg:mt-0">
            {/* Recommendation Tag */}
            <div className="absolute -top-10 left-0 right-0 flex justify-center items-center gap-2 text-[#6219D1] font-bold text-xs">
            ...
            <div className="bg-white rounded-[2.5rem] p-10 shadow-2xl border-2 border-purple-100 text-left flex flex-col h-full">
              ...
              <div className="text-center mb-8">
                <h3 className="text-lg font-bold text-gray-900 mb-4">Beginner to Advanced Transformation</h3>
                <div className="flex items-center justify-center mb-1">
                  <span className="text-4xl font-black text-gray-900">₦250,000</span>
                </div>
