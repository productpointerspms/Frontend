  ...
  return (
    <section className="bg-[#FAF5FF] py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <h3 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#6D28D9] italic mb-6">
          You Need Clarity
        </h3>
        <p className="text-gray-500 mb-16 max-w-3xl mx-auto text-lg leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16 text-left">
          <div className="bg-white p-8 lg:p-10 rounded-[2rem] shadow-sm border border-gray-50">
            ...
            <h3 className="font-bold text-[#1a1a1a] text-xl mb-3">Clarity</h3>
          ...
          <div className="bg-white p-8 lg:p-10 rounded-[2rem] shadow-sm border border-gray-50">
            ...
            <h3 className="font-bold text-[#1a1a1a] text-xl mb-3">Direction</h3>
            <p className="text-gray-500 leading-relaxed">
          ...
          <div className="bg-white p-8 lg:p-10 rounded-[2rem] shadow-sm border border-gray-50">
            ...
            <h3 className="font-bold text-[#1a1a1a] text-xl mb-3 pr-4">A Starting Point That Makes Sense</h3>
            <p className="text-gray-500 leading-relaxed">
        ...
        <button className="bg-[#6D28D9] text-white px-8 py-4 rounded-xl font-medium text-lg hover:bg-[#5b21b6] transition-colors inline-flex items-center gap-2">
