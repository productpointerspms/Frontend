    ...
    <section className="bg-[#FAF5FF] py-20 px-6 md:px-12 lg:px-24 flex flex-col md:flex-row items-center justify-between gap-12 min-h-[80vh]">
      <div className="max-w-2xl flex-1">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-10">
          <button className="bg-[#5B21B6] text-white px-8 py-4 rounded-xl font-medium hover:bg-purple-800 transition-colors flex items-center justify-center gap-2 text-base">
            Join the Next Cohort <ArrowRight className="w-5 h-5" />
          </button>
          <button className="bg-transparent text-[#1a1a1a] border border-gray-400 px-8 py-4 rounded-xl font-medium hover:bg-gray-50 transition-colors text-base">
          ...
          <div className="relative z-10 flex flex-col items-center transform rotate-[-3deg] hover:rotate-0 transition-transform duration-500">
            ...
            <div className="bg-[#6D28D9] p-2 rounded-2xl shadow-xl z-20 mb-[-1.5rem]">
              <div className="bg-[#FAF5FF] rounded-xl px-6 py-2 flex gap-2">
                 <span className="text-6xl lg:text-8xl font-black text-[#6D28D9] tracking-tighter" style={{ WebkitTextStroke: '2px #6D28D9' }}>P</span>
                 <span className="text-6xl lg:text-8xl font-black text-[#6D28D9] tracking-tighter" style={{ WebkitTextStroke: '2px #6D28D9' }}>P</span>
              </div>
            </div>
            ...
            <div className="bg-[#6D28D9] p-2 rounded-2xl shadow-xl z-10 w-[110%] flex justify-center ml-4">
              <div className="bg-[#FAF5FF] rounded-xl px-8 py-3 flex gap-2 w-full justify-center">
                 <span className="text-6xl lg:text-8xl font-black text-[#6D28D9] tracking-tighter" style={{ WebkitTextStroke: '2px #6D28D9' }}>A</span>
                 <span className="text-6xl lg:text-8xl font-black text-[#6D28D9] tracking-tighter" style={{ WebkitTextStroke: '2px #6D28D9' }}>P</span>
              </div>
            </div>
            ...
            <div className="relative z-30 mt-[-1.5rem] ml-2">
              ...
              <div className="relative bg-[#EF4444] text-white px-8 py-3 rounded-full font-black text-lg lg:text-2xl tracking-wide transform -rotate-2 border-2 border-white shadow-lg">
                FOUNDATION
              </div>
            </div>
          </div>
