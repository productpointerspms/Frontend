  ...
  return (
    <section className="relative min-h-[90vh] w-full bg-[#FCF1FF] flex items-center justify-center pt-10 pb-20 overflow-hidden font-montserrat">
      <div className="container mx-auto px-6 max-w-5xl flex flex-col items-center text-center">
        ...
        {/* Main Heading */}
        <h1 className="text-[#1A1A1A] font-extrabold text-[24px] sm:text-2xl md:text-[28px] lg:text-[34px] xl:text-[40px] leading-[1.2] mb-10 tracking-tight text-center">
        ...
        {/* Subheadings */}
        <div className="space-y-6 mb-12 w-full flex flex-col items-center text-center">
          <p className="text-gray-600 font-semibold text-sm md:text-[16px] max-w-2xl mx-auto">
          ...
          <p className="text-gray-500 font-medium text-sm md:text-[16px] leading-relaxed max-w-3xl mx-auto">
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-4 mb-16 self-center md:self-center justify-center items-center w-full sm:w-auto">
          <a
        ...
        {/* Social Proof */}
        <div className="flex items-center justify-center gap-4 self-center md:self-center w-full sm:w-auto">
          ...
          <p className="text-gray-500 text-xs font-medium">
            {stats.professionalsTrained} PMs Mentored Across Africa
          </p>
        </div>
