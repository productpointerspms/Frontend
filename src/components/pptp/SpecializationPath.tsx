  ...
  return (
    <section className="bg-[#FDF2FF] py-20 px-6 font-montserrat">
      <div className="max-w-6xl mx-auto text-center">
        <h2 className="text-4xl font-bold mb-4 text-black">Choose Your Specialization Path</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {tracks.map((track, i) => (
            <div key={i} className="bg-white p-8 rounded-[32px] text-left border border-gray-100 shadow-sm flex flex-col">
              ...
              <h3 className="text-2xl font-bold text-black mb-6">{track.title}</h3>
              ...
              <div className="pt-6 border-t border-gray-100">
                <p className="text-gray-500 text-sm mb-4">{track.footer}</p>
