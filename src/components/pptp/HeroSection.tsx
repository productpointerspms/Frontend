    ...
    return (
        <section className="bg-[#FDF2FF] min-h-[80vh] flex items-center px-6 py-12 md:px-20 font-montserrat">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                    <span className="inline-block bg-[#F4EBFF] text-[#6024D0] px-4 py-1 rounded-full text-sm font-medium mb-6 border border-[#E9D7FE]">
                        Advanced PM Specialization
                    </span>
                    <h1 className="text-4xl md:text-6xl font-extrabold text-[#101828] leading-[1.1] mb-6">
                        You’re Already A Product Manager... <br />
                        <span className="text-[#6024D0]">But You’re Still Not Standing Out</span>
                    </h1>
                    <p className="text-[#475467] text-lg md:text-xl mb-10 max-w-xl">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4">
                        <Link href="/pptp/apply" className="bg-[#6024D0] text-white text-sm px-5 py-2 rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#4d1ba8] transition-all">
                            Apply for the Next Cohort <ChevronRight size={20} />
                        </Link>
                        <button className="bg-white border border-[#101828] text-[#101828] text-sm px-5 py-2 rounded-xl font-bold hover:bg-gray-50 transition-all">
                    ...
                    <div className="mt-8 flex items-center gap-3">
                        ...
                        <p className="text-sm text-[#475467]">Join ambitious Product Managers standing out through ProductPointers.</p>
                    </div>
                </div>
