            ...
            >
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 rounded-md border border-purple-200 bg-[#FCF8FF] text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#5C1CC5] transition-shadow placeholder-gray-400 text-xs"
                    />
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full px-4 py-3 rounded-md border border-purple-200 bg-[#FCF8FF] text-gray-900 focus:outline-none focus:ring-2 focus:ring-[#5C1CC5] transition-shadow placeholder-gray-400 text-xs resize-none"
                    ></textarea>
                </div>
