    ...
    return (
        <div className="min-h-screen bg-[#FCF1FF] py-10 px-4 sm:px-6 lg:px-8 font-montserrat">
            <div className="max-w-3xl mx-auto">
                ...
                <Link
                    href="/"
                    className="text-[#5C1CC5] hover:underline flex items-center text-sm font-medium mb-8 shrink-0"
                >
                ...
                <div className="text-center mb-8">
                    ...
                    <div className="bg-[#EBD5FF] border border-[#D1B3FF] rounded-lg p-4 text-[#5C1CC5] text-sm font-medium inline-block w-full md:w-3/4 shadow-sm">
            ...
            >
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full px-4 py-3 rounded-md border border-purple-200 bg-[#FCF8FF] focus:outline-none focus:ring-2 focus:ring-[#5C1CC5] transition-shadow placeholder-gray-400 text-sm"
                    />
                </div>
                    ...
                    <div className="space-y-2">
                        {["Less than 1 year", "1–2 years", "3–4 years", "5+ years"].map((exp) => (
                            <label key={exp} className="flex items-center space-x-3 cursor-pointer group">
                                ...
                                />
                                <span className="text-sm text-gray-700 group-hover:text-black">{exp}</span>
                            </label>
                        ))}
                    </div>
                </div>
                        ...
                        {["Startup", "Mid-size company", "Enterprise", "Freelancer / Consultant", "Unemployed"].map((org) => (
                            <label key={org} className="flex items-center space-x-3 cursor-pointer group">
                                <input
                                    ...
                                    className="w-4 h-4 text-[#5C1CC5] border-gray-300 focus:ring-[#5C1CC5] cursor-pointer"
                                />
                                <span className="text-sm text-gray-700 group-hover:text-black">{org}</span>
                            </label>
                        ))}
                    </div>
                </div>
                ...
                <div>
                    ...
                    <textarea
                        ...
                        className="w-full px-4 py-3 rounded-md border border-purple-200 bg-[#FCF8FF] focus:outline-none focus:ring-2 focus:ring-[#5C1CC5] transition-shadow placeholder-gray-400 text-sm resize-none"
                    ></textarea>
                </div>
...
function StepTwo({ onBack }: { onBack: () => void }) {
    ...
    return (
        <div className="animate-in fade-in slide-in-from-right-4 duration-500">
            <div className="bg-[#5C1CC5] text-white p-4 rounded-lg mb-8">
                <h2 className="text-lg font-medium">PART 2: Product Management Assessment</h2>
            </div>
