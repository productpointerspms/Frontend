...
export default function CheckoutClient() {
  ...
  const totalDue = format(PPIP_COMMITMENT_FEE_NGN, currency);

  return (
    <div className="min-h-screen w-full bg-[#FCF8FF] py-12 px-4 sm:px-6 lg:px-10 font-montserrat">
      {/* Heading */}
      <div className="text-center mb-12">
        ...
        <p className="text-gray-500 max-w-xl mx-auto text-sm md:text-base">
          Secure your spot in the next ProductPointers internship cohort by
          completing your payment below.
        </p>
      </div>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-[1fr_minmax(0,420px)] gap-8 items-start">
        ...
        <aside className="bg-white rounded-[28px] shadow-sm p-6 sm:p-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-[#15010D] leading-snug">
                ProductPointers Internship Program (PPIP)
              </h3>
              <p className="text-xs text-gray-400 mt-1">
                Execution-Focused Product Internship
              </p>
          ...
          {/* Fee */}
          <div>
            <p className="text-sm text-gray-500 mb-1">Commitment Fee</p>
            <p className="text-sm text-gray-400 line-through">
              {format(PPIP_ORIGINAL_FEE_NGN, currency)}
            </p>
            <div className="flex items-center gap-3 mt-1">
              ...
              <span className="inline-flex items-center gap-1 bg-[#F3E8FF] text-[#6024D0] text-[11px] font-semibold px-2.5 py-1 rounded-full">
                <Tag className="w-3 h-3" /> Scholarship
              </span>
            </div>
            <p className="text-xs text-[#10B981] mt-1">
              save {format(PPIP_ORIGINAL_FEE_NGN - PPIP_COMMITMENT_FEE_NGN, currency)} on
              this offer
            </p>
          </div>
